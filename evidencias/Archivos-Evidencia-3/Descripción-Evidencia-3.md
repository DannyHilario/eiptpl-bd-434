...
Instala **RestauranteDB** siguiendo el plan de instalación incluido en la carpeta [`datos-restaurante/`](datos-restaurante/README.md). La base de datos contiene una sola tabla (`Comanda`) con 300 registros del año 2025.
